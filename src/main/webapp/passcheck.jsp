    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Pass availability</h1>

          <div class="row row-cols-1">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Check pass availability</h6>
                </div>
                ...
                <form id="passForm">
                  ...
                  <div class="col">
                  <select class="form-control" name="fromLoc">
                    <c:forEach var="titems" items="${sessionScope.tableData }">
                      <option>${titems.stateName}</option>
                  </c:forEach>
                  </select>
                </div>
              </div>
              <br><br>
                <div class="form-row">
                  ...
                  <div class="col">
                  <select class="form-control" name="toLoc">
                    <c:forEach var="titems" items="${sessionScope.tableData }">
                      <option>${titems.stateName}</option>
                  </c:forEach>
                  </select>
              ...
              <div class="col"></div>
              <div class="col">
                <div class="d-flex justify-content-center"><input type="submit" class="btn btn-primary"name="checkPass" value="Check"></div>
              </div>
              <div class=col></div>
            </div>
                </form>
                <br><br>
                <div class="d-flex justify-content-center"><h3><span id="Passmessage" class="text-gray-900"></span></h3></div>
                </div>
              </div>
          </div>
