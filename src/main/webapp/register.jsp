        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" action="RegistrationServlet" method="post">
                ...
                <div class="form-group">
                  <input type="email" name="EmailId" class="form-control form-control-user" id="exampleInputEmail" placeholder="Email Address">
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <div>
                      <div>
                        <i id="messageInvalid" style="color: red">${registrationMessage}</i>
                      </div>
                    </div>
